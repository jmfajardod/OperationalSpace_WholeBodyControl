...
void OSC_Controller::CartesianImpedance(  Eigen::Vector3d mTargetPos, 
...
void OSC_Controller::AchieveCartesian(  Eigen::Vector3d mTargetPos, 
                                    Eigen::Vector3d mTargetVel,
                                    Eigen::Vector3d mTargetAccel, 
                                    double *svd_position,
                                    int cycle,
...
void OSC_Controller::AchieveCartesianConstVel(  Eigen::Vector3d mTarget, 
                                            double *svd_position,
                                            int cycle,
                                            Eigen::MatrixXd M, 
                                            Eigen::VectorXd C_t,
