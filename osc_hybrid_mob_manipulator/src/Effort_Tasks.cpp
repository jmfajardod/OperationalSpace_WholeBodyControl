...
void EffortTask::AchieveOrientationAxis2(Eigen::VectorXd *tau_zero, 
                                        Eigen::VectorXd *tau_result,
                                        Eigen::Matrix3d rot_mat_desired, 
                                        Eigen::MatrixXd M,
                                        Eigen::VectorXd C_t,
    ...
    Eigen::Vector3d f_t_star =  kd * (-angular_vel) + kp * ( sin(u_ee.angle())* u_ee.axis()) ; // Command force vector
    //std::cout << "F star: \n" << f_t_star << std::endl;
...
void EffortTask::AchieveOrientationQuat2(Eigen::VectorXd *tau_zero, 
                                        Eigen::VectorXd *tau_result,
                                        Eigen::Matrix3d rot_mat_desired, 
                                        Eigen::MatrixXd M,
                                        Eigen::VectorXd C_t,
    ...
    Eigen::Vector3d f_t_star =   kd *(-angular_vel) + kp * vec_des ; // Command force vector
    //std::cout << "F star: \n" << f_t_star << std::endl;
...
void EffortTask::AchieveOrientationQuat3(Eigen::VectorXd *tau_zero, 
                                        Eigen::VectorXd *tau_result,
                                        Eigen::Matrix3d rot_mat_desired, 
                                        Eigen::MatrixXd M,
                                        Eigen::VectorXd C_t,
