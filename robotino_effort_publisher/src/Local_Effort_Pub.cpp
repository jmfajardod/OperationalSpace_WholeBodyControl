...
float LocalEffortPub::constrainAngle(float x){
    // Wrap to [0,2*pi]
    x = fmod(x,2*M_PI);
    if (x < 0)
        x += 2*M_PI;
...
void LocalEffortPub::Cmd_Wrench_callback(const geometry_msgs::Wrench msg){

    f(0) = msg.force.x;
    f(1) = msg.force.y;
    f(2) = msg.torque.z;

    std::cout << "Command Forces: \n" << f << std::endl;
...
////////////////////////////////////////////////////////////////////////////////
// Constructor
LocalEffortPub::LocalEffortPub(ros::NodeHandle& nodeHandle) :
    ...
    f(Eigen::VectorXd::Zero(3))
{
    ...
    Jacob = J1.inverse() * J2 ;
    std::cout << "Jacobian: \n" << Jacob << std::endl;
    Jacob_trans = Jacob.transpose();
    std::cout << "Transpose Jacobian: \n" << Jacob_trans << std::endl;

    // Create subscribers
    subs_cmd_vel_= nodeHandle_.subscribe("/"+ robot_name +"/commands/velocity" , 10, 
                                        &LocalEffortPub::Cmd_Wrench_callback, this);
...
////////////////////////////////////////////////////////////////////////////////
// Destructor
LocalEffortPub::~LocalEffortPub()
{
}

////////////////////////////////////////////////////////////////////////////////
// Function to load parameters
bool LocalEffortPub::readParameters()
{
