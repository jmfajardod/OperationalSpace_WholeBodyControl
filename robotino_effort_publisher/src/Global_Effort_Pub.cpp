...
float GlobalEffortPub::constrainAngle(float x){
    // Wrap to [0,2*pi]
    x = fmod(x,2*M_PI);
    if (x < 0)
        x += 2*M_PI;
...
void GlobalEffortPub::Cmd_Wrench_callback(const geometry_msgs::Wrench msg){
...
////////////////////////////////////////////////////////////////////////////////
// Constructor
GlobalEffortPub::GlobalEffortPub(ros::NodeHandle& nodeHandle) :
...
////////////////////////////////////////////////////////////////////////////////
// Destructor
GlobalEffortPub::~GlobalEffortPub()
{
}

////////////////////////////////////////////////////////////////////////////////
// Function to load parameters
bool GlobalEffortPub::readParameters()
{
