...
if __name__ == '__main__':
    ...
    while(rospy.is_shutdown() is not True):
        ...
        Msg.pose.translation.x = init_pos[0]  + np.abs( 0.3*np.math.sin(frecuency*current_time + offset_time) )
        Msg.pose.translation.y = init_pos[1]  + 0.1*np.math.sin(frecuency*current_time + offset_time)
